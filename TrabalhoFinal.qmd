...
*Kolmogorov-Smirnoff* corrobora isto, não havendo evidência para
...
precos.energia %>%
  ...
  labs(
    ...
    y = "densidade de probabilidade", 
    title = "Distribuição dos preços da energia elétrica no mercado Ibérico no ano de 2022"
  ) + theme_minimal()
```
...
descrever ajuste da mistrura gaussiana
